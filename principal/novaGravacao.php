...
echo <<< Bloco
    ...
    <table>
     <tr>
       <td colspan='3' class='cabecaTabela'>Cadastrar Pessoa Simples </td>
     </tr>
     <tr>
        <td>Nome Gravação:<input type='text' name='nome'></td>
     </tr>

     <tr>
       <td>Musica: <input type='button' name='musica' value ='Clicar Aqui'></td>
    </tr>

       <tr>
      <td >link gravacao: <input type='text' name='cpf'> </td>
    </tr>
    <tr>
      <td >video esta no youtube:
         <input type='radio' name='is_youtube' value='t'>sim
          <input type='radio' name='is_youtube' value='f'>Não
      </td>
    </tr>
